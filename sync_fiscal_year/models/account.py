...
class AccountAccount(models.Model):
    ...
    balance = fields.Float(compute="compute_values", digits='Account', string='Balance')
    credit = fields.Float(compute="compute_values", digits='Account', string='Credit')
    debit = fields.Float(compute="compute_values", digits='Account', string='Debit')
